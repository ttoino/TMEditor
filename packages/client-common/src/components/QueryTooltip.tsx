    ...
    return (
        <TooltipPrimitive.Root>
            ...
            <StyledContent>
                ...
                <StyledInfoRow>
                    <dt>Timestamp: </dt>
                    <StyledTimestampValue error={hasError}>
